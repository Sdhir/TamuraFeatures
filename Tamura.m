...
tic
%Grade 1
% IColor = imread('OU13-005-4_seg_5_normal.tif');
% IColor = imread('OU13-020-4_seg_5_normal.tif');
%Grade 2
% IColor = imread('OU13-001-4_seg_6_cin1.tif');
% IColor = imread('OU13-016-4_seg_4_cin1.tif');
%g3
% IColor = imread('OU13-005-3_seg_8_cin2.tif');
% IColor = imread('OU13-018-1_seg_4_cin2.tif');
%g4
% IColor = imread('OU13-007-5_seg_5_cin3.tif');
